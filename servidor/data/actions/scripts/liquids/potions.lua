...
local POTIONS = {
	...
	[7588] = {empty = 7634, splash = 42, health = {200, 400}, level = 50, vocations = {3, 13, 23, 4, 14, 24, 5, 15, 25, 6, 16, 26, 7, 17, 27, 8, 18, 28}, vocStr = "elfians, amazons, ninjas, wild, monks and dwarfians"}, -- strong health potion
	[7591] = {empty = 7635, splash = 42, health = {500, 700}, level = 80, vocations = {4, 14, 24, 7, 17, 27}, vocStr = "dwarfians and wilds"}, -- great health potion
	[8473] = {empty = 7635, splash = 42, health = {800, 1000}, level = 130, vocations = {4, 14, 24, 7, 17, 27}, vocStr = "dwarfians and wilds"}, -- ultimate health potion

	[7620] = {empty = 7636, splash = 47, mana = {70, 130}}, -- mana potion
	[7589] = {empty = 7634, splash = 47, mana = {110, 190}, level = 50, vocations = {1, 11, 21, 2, 12, 22, 3, 13, 23, 5, 15, 25, 6, 16, 26, 8, 18, 28}, vocStr = "sorcerers, tribais, elfians, amazons, ninjas and monks"}, -- strong mana potion
	[7590] = {empty = 7635, splash = 47, mana = {200, 300}, level = 80, vocations = {1, 11, 21, 2, 12, 22, 8, 18, 28}, vocStr = "sorcerers, tribias and monks"}, -- great mana potion

	[8472] = {empty = 7635, splash = 43, health = {200, 400}, mana = {110, 190}, level = 80, vocations = {3, 13, 23, 6, 16, 26}, vocStr = "elfians and amazons"} -- great spirit potion
}
