-- The Forgotten Server Config
	...
	newPlayerSpawnPosX = 2050
	newPlayerSpawnPosY = 2050
	...
	maxPlayers = 1000
	motd = "Infelizmente o servidor está sem recurso capital para se manter online e deverá fechar as portas em abril. Agradecemos os que jogaram!"
	displayOnOrOffAtCharlist = false
	onePlayerOnlinePerAccount = true
	allowClones = 0
	serverName = "Time Travel Open Tibia Server"
	loginMessage = "Nossa equipe nunca irá pedir seu login ou senha"
	...
	-- Mounts
	useMounts = true
	unmountPlayerInPz = false

	-- VIP list
	separateVipListPerCharacter = false
	vipListDefaultLimit = 30
	...
	-- Status
	statusPort = 7171
	ownerName = "Ricardo Azzi Silva"
	ownerEmail = "ttots.contato@gmail.com"
	url = "http://www.timetravel.net.br"
	location = "Brazil"
