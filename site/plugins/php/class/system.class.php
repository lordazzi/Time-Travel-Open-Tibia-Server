...
class System {
	...
	public function using($who) {
		if (strtolower($who) == "pagseguro") {
			require_once($_SERVER["DOCUMENT_ROOT"]."/plugins/php/class/pagseguro/PagSeguroLibrary.php");
		} else if (strtolower($who) == "phpmailer") {
			require_once($_SERVER["DOCUMENT_ROOT"]."/plugins/php/class/phpmailer/class.phpmailer.php");
		} else if (strtolower($who) == "paypal") {
		}
	}
